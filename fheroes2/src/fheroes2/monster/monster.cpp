...
static const struct
{
	...
	{     1,   1,   1,   1,   1,  Speed::VERYSLOW,  12, "Peasant"        , "Peasants" },
	{     5,   3,   2,   3,  10,  Speed::VERYSLOW,   8, "Archer"         , "Archers" },
	{     5,   3,   2,   3,  10,   Speed::AVERAGE,   8, "Ranger"         , "Rangers" },
	{     5,   9,   3,   4,  15,   Speed::AVERAGE,   5, "Pikeman"        , "Pikeman" },
	{     5,   9,   3,   4,  20,      Speed::FAST,   5, "Veteran Pikeman", "Veteran Pikeman" },
	{     7,   9,   4,   6,  25,   Speed::AVERAGE,   4, "Swordsman"      , "Swordsman" },
	{     7,   9,   4,   6,  30,      Speed::FAST,   4, "Master Swordman", "Master Swordman" },
	{    10,   9,   5,   9,  30,  Speed::VERYFAST,   3, "Cavalry"        , "Cavalries" },
	{    10,   9,   5,  10,  40, Speed::ULTRAFAST,   3, "Champion"       , "Champions" },
	{    11,  12,  10,  20,  50,      Speed::FAST,   2, "Paladin"        , "Paladins" },
	{    11,  12,  10,  20,  65,  Speed::VERYFAST,   2, "Crusader"       , "Crusaders" },

	// atck dfnc  min  max   hp             speed grwn  name               multiname
	{     3,   1,   1,   2,   3,   Speed::AVERAGE,  10, "Goblin"         , "Goblins" },
	{     3,   4,   2,   3,  10,  Speed::VERYSLOW,   8, "Orc"            , "Orcs" },
	{     3,   4,   3,   4,  15,      Speed::SLOW,   8, "Orc Chief"      , "Orc Chiefs" },
	{     6,   2,   3,   5,  20,  Speed::VERYFAST,   5, "Wolf"           , "Wolves" },
	{     9,   5,   4,   6,  40,  Speed::VERYSLOW,   4, "Ogre"           , "Ogres" },
	{     9,   5,   5,   7,  60,   Speed::AVERAGE,   4, "Ogre Lord"      , "Ogre Lords" },
	{    10,   5,   5,   7,  40,   Speed::AVERAGE,   3, "Troll"          , "Trolls" },
	{    10,   5,   7,   9,  40,      Speed::FAST,   3, "War Troll"      , "War Troll" },
	{    12,   9,  12,  24,  80,      Speed::FAST,   2, "Cyclops"        , "Cyclopes" },

	// atck dfnc  min  max   hp             speed grwn  name               multiname
	{     4,   2,   1,   2,   2,   Speed::AVERAGE,   8, "Sprite"         , "Sprites" },
	{     6,   5,   2,   4,  20,  Speed::VERYSLOW,   6, "Dwarf"          , "Dwarves" },
	{     6,   6,   2,   4,  20,   Speed::AVERAGE,   6, "Battle Dwarf"   , "Battle Dwarves" },
	{     4,   3,   2,   3,  15,   Speed::AVERAGE,   4, "Elf"            , "Elves" },
	{     5,   5,   2,   3,  15,  Speed::VERYFAST,   4, "Grand Elf"      , "Grand Elves" },
	{     7,   5,   5,   8,  25,      Speed::FAST,   3, "Druid"          , "Druids" },
	{     7,   7,   5,   8,  25,  Speed::VERYFAST,   3, "Greater Druid"  , "Greater Druids" },
	{    10,   9,   7,  14,  40,      Speed::FAST,   2, "Unicorn"        , "Unicorns" },
	{    12,  10,  20,  40, 100, Speed::ULTRAFAST,   1, "Phoenix"        , "Phoenix" },

	// atck dfnc  min  max   hp             speed grwn  name               multiname
	{     3,   1,   1,   2,   5,   Speed::AVERAGE,   8, "Centaur"        , "Centaurs" },
	{     4,   7,   2,   3,  15,  Speed::VERYFAST,   6, "Gargoyle"       , "Gargoyles" },
	{     6,   6,   3,   5,  25,   Speed::AVERAGE,   4, "Griffin"        , "Griffins" },
	{     9,   8,   5,  10,  35,   Speed::AVERAGE,   3, "Minotaur"       , "Minotaurs" },
	{     9,   8,   5,  10,  45,  Speed::VERYFAST,   3, "Minotaur King"  , "Minotaur Kings" },
	{     8,   9,   6,  12,  75,  Speed::VERYSLOW,   2, "Hydra"          , "Hydras" },
	{    12,  12,  25,  50, 200,   Speed::AVERAGE,   1, "Green Dragon"   , "Green Dragons" },
	{    13,  13,  25,  50, 250,      Speed::FAST,   1, "Red Dragon"     , "Red Dragons" }, 
	{    14,  14,  25,  50, 300,  Speed::VERYFAST,   1, "Black Dragon"   , "Black Dragons" },

	// atck dfnc  min  max   hp             speed grwn  name               multiname
	{     2,   1,   1,   3,   3,      Speed::SLOW,   8, "Halfling"       , "Halflings" },
	{     5,   4,   2,   3,  15,  Speed::VERYFAST,   6, "Boar"           , "Boars" },
	{     5,  10,   4,   5,  30,  Speed::VERYSLOW,   4, "Iron Golem"     , "Iron Golems" },
	{     7,  10,   4,   5,  35,      Speed::SLOW,   4, "Steel Golem"    , "Steel Golems" },
	{     7,   7,   4,   8,  40,   Speed::AVERAGE,   3, "Roc"            , "Rocs" },
	{    11,   7,   7,   9,  30,      Speed::FAST,   2, "Mage"           , "Mage" },
	{    12,   8,   7,   9,  35,  Speed::VERYFAST,   2, "Archmage"       , "Archmage" },
	{    13,  10,  20,  30, 150,   Speed::AVERAGE,   1, "Giant"          , "Giants" },
	{    15,  15,  20,  30, 300,  Speed::VERYFAST,   1, "Titan"          , "Titans" },

	// atck dfnc  min  max   hp             speed grwn  name               multiname
	{     4,   3,   2,   3,   4,   Speed::AVERAGE,   8, "Skeleton"       , "Skeletons" },
	{     5,   2,   2,   3,  15,  Speed::VERYSLOW,   6, "Zombie"         , "Zombies" },
	{     5,   2,   2,   3,  25,   Speed::AVERAGE,   6, "Mutant Zombie"  , "Mutant Zombies" },
	{     6,   6,   3,   4,  25,   Speed::AVERAGE,   4, "Mummy"          , "Mummys" },
	{     6,   6,   3,   4,  30,      Speed::FAST,   4, "Royal Mummy"    , "Royal Mummys" },
	{     8,   6,   5,   7,  30,   Speed::AVERAGE,   3, "Vampire"        , "Vampires" },
	{     8,   6,   5,   7,  40,      Speed::FAST,   3, "Lord Vampire"   , "Lord Vampires" },
	{     7,  12,   8,  10,  25,      Speed::FAST,   2, "Lich"           , "Lichs" },
	{     7,  13,   8,  10,  35,  Speed::VERYFAST,   2, "Power Lich"     , "Power Lichs" }, 
	{    11,   9,  25,  45, 150,   Speed::AVERAGE,   1, "Bone Dragon"    , "Bone Dragons" },

        // atck dfnc  min  max   hp             speed grwn  name               multiname
	{     6,   1,   1,   2,   4,      Speed::FAST,   4, "Rogue"          , "Rogues" },
	{     7,   6,   2,   5,  20,  Speed::VERYFAST,   4, "Nomad"          , "Nomads" },
	{     8,   7,   4,   6,  20,      Speed::FAST,   4, "Ghost"          , "Ghosts" },
	{    10,   9,  20,  30,  50,  Speed::VERYFAST,   4, "Genie"          , "Genies" },
	{     8,   9,   6,  10,  35,   Speed::AVERAGE,   4, "Medusa"         , "Medusas" },
	{     8,   8,   4,   5,  50,      Speed::SLOW,   4, "Earth Element"  , "Earth Elements" },
	{     7,   7,   2,   8,  35,  Speed::VERYFAST,   4, "Air Element"    , "Air Elements" },
	{     8,   6,   4,   6,  40,      Speed::FAST,   4, "Fire Element"   , "Fire Elements" },
	{     6,   8,   3,   7,  45,   Speed::AVERAGE,   4, "Water Element"  , "Water Elements" },
