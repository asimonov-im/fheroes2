...
namespace Army
{
	...
	SP_BLIND	= 0x00400000,
	SP_DRAGONSLAYER	= 0x00800000,
	SP_STEELSKIN	= 0x01000000,
	SP_ANTIMAGIC	= 0x02000000,
	SP_PARALYZE	= 0x04000000,
	SP_BERSERKER	= 0x08000000,
	SP_HYPNOTIZE	= 0x10000000,
	SP_MIRRORIMAGE	= 0x20000000,
	SP_STONE	= 0x40000000,
	SP_DISRUPTINGRAY= 0x80800000,
