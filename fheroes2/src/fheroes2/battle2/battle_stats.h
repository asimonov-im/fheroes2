...
namespace Battle2
{
	...
	IS_PARALIZE_MAGIC=0xE0000000,
	IS_MIND_MAGIC	= 0x88000000,
	IS_BAD_MAGIC	= 0xFE000000,
        IS_MAGIC        = 0xFFFE0000,

	IS_RED_STATUS	= IS_BAD_MAGIC,
	IS_YELLOW_STATUS= SP_SHIELD | SP_STEELSKIN | SP_STONESKIN | SP_DRAGONSLAYER,
	IS_GREEN_STATUS = SP_BLOODLUST | SP_BLESS | SP_HASTE | SP_ANTIMAGIC,
    };
