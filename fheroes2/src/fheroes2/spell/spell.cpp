...
static spellstats_t spells[] = {
	...
	{ _("Haste"),                   3, 14,     2, _("Increases the speed of any creature by %{count}.") }, 
	{ _("Mass Haste"),             10, 14,     2, _("Increases the speed of all of your creatures by %{count}.") }, 
	{ _("spell|Slow"),              3,  1,     2, _("Slows target to half movement rate.") }, 
	{ _("Mass Slow"),              15,  1,     2, _("Slows all enemies to half movement rate.") }, 
