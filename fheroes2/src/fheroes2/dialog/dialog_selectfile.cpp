...
void RedrawMapsFileList(const Point &, const MapsFileInfoList &, MapsFileInfoList::const_iterator, MapsFileInfoList::const_iterator, const u8);
...
bool Dialog::SelectMapsFile(std::string & filename)
{
    ...
    return DialogSelectMapsFileList(lists, filename);
}
...
void RedrawMapsFileList(const Point & dst, const MapsFileInfoList & lists, MapsFileInfoList::const_iterator top, MapsFileInfoList::const_iterator cur, const u8 max_items)
{
    Display & display = Display::Get();
