...
Uint8	rndBlue;		// случайная раса королевства (01 - нет, 00 - да)
Uint8	rndGreen;		// случайная раса королевства (01 - нет, 00 - да)
Uint8	rndRed;			// случайная раса королевства (01 - нет, 00 - да)
Uint8	rndYellow;		// случайная раса королевства (01 - нет, 00 - да)
Uint8	rndOrange;		// случайная раса королевства (01 - нет, 00 - да)
Uint8	rndPurple;		// случайная раса королевства (01 - нет, 00 - да)
...
Uint8	raceBlue;		// 00 - kngt, 01 - barb, 02 - sorc, 03 - wrlk, 04 - wzrd, 05 - necr, 06 - mult, 07 - rnd, ff - none
Uint8	raceGreen;		// 00 - kngt, 01 - barb, 02 - sorc, 03 - wrlk, 04 - wzrd, 05 - necr, 06 - mult, 07 - rnd, ff - none
Uint8	raceRed;		// 00 - kngt, 01 - barb, 02 - sorc, 03 - wrlk, 04 - wzrd, 05 - necr, 06 - mult, 07 - rnd, ff - none
Uint8	raceYellow;		// 00 - kngt, 01 - barb, 02 - sorc, 03 - wrlk, 04 - wzrd, 05 - necr, 06 - mult, 07 - rnd, ff - none
Uint8	raceOrange;		// 00 - kngt, 01 - barb, 02 - sorc, 03 - wrlk, 04 - wzrd, 05 - necr, 06 - mult, 07 - rnd, ff - none
Uint8	racePurple;		// 00 - kngt, 01 - barb, 02 - sorc, 03 - wrlk, 04 - wzrd, 05 - necr, 06 - mult, 07 - rnd, ff - none
Uint8	t2[14];			// неопределенный блок 20 байт
